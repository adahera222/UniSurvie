...
public class SaveGameManager : MonoBehaviour
{
	...
	void GetAllReferences()
	{
		...
		var assets = types.Select(t=>UnitySerializer.GetTypeEx(t)).Where(t=>t!=null).SelectMany(t=>Resources.FindObjectsOfTypeAll(t))
			.Concat(Resources.FindObjectsOfTypeAll(typeof(GameObject)).Cast<GameObject>().SelectMany(g=>g.GetAllComponentsInChildren<Component>().Select(t=>(UnityEngine.Object)t.gameObject)))
